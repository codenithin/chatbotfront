...
const doneSpan = "hover:cursor-pointer w-6 h-6 font-bold bg-[#2563EB] border-2 border-transparent rounded-full flex justify-center items-center mx-auto mb-3 text-sm text-white lg:w-10 lg:h-10"
...
const selectedSpan = "hover:cursor-pointer w-6 h-6 bg-indigo-50 border-2 border-[#2563EB] rounded-full flex justify-center items-center mx-auto mb-3 text-sm text-[#2563EB] lg:w-10 lg:h-10"
...
const notDoneSpan = "hover:cursor-pointer w-6 h-6 bg-gray-50 border-2 border-gray-200 rounded-full flex justify-center items-center mx-auto mb-3 text-sm  lg:w-10 lg:h-10"

const last = "flex w-full relative text-gray-900  "
const lastSpan = "w-6 h-6 bg-gray-50 border-2 border-gray-200 rounded-full flex justify-center items-center mx-auto mb-3 text-sm  lg:w-10 lg:h-10"
    ...
    return (
        ...
        >
            <div className='bg-white text-black fixed flex flex-col justify-center items-center rounded-md px-20 py-10 min-w-[60%]'>
                ...
                <ol className="flex items-center w-full text-xs text-gray-900 font-medium pt-10 pl-[10%]">
                    {
                        itemsProp?.map((x, i) => (
                ...
                <div className='min-h-20 my-20 flex justify-center items-center '>
                    { selectedText && 
