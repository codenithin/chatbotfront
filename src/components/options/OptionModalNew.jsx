...
const done = "relative flex-1 after:content-['']  after:w-0.5 after:h-full  after:bg-[#2563EB] after:absolute after:left-5 after:-bottom-11 "
...
const selected = "relative flex-1 after:content-['']  after:w-0.5 after:h-full  after:bg-gray-200 after:absolute after:left-4 lg:after:left-5 after:-bottom-11"
...
const notDone = "relative flex-1 after:content-['']  after:w-0.5 after:h-full  after:bg-gray-200 after:absolute after:left-5 after:-bottom-11"
